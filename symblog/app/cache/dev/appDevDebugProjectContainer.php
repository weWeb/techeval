...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'newspaper', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager50768929a76dd_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager50768929a76dd_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/symblog/app/cache/dev/jms_diextra/doctrine/EntityManager_50768929a76dd.php';
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/symblog/src/Blogger/BlogBundle/Entity')), 'Blogger\\BlogBundle\\Entity');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50768929a76dd_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '8cbb584ab3b563e794dd501b1879c229');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/symblog/app/cache/dev/jms_diextra/metadata'));
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/var/www/symblog/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/symblog/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/symblog/app/cache/dev/sessions');
    }
    ...
    protected function getSwiftmailer_Transport_RealService()
    {
        ...
        $instance->setUsername('group10weweb');
        $instance->setPassword('fall2012cmpt470');
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/symblog/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/var/www/symblog/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
     ...
     *
     * @return EntityManager50768929a76dd_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/www/symblog/app/cache/dev/jms_security', true));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'newspaper',
            'mailer_transport' => 'gmail',
            'mailer_encryption' => 'ssl',
            'mailer_auth_mode' => 'login',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'group10weweb',
            'mailer_password' => 'fall2012cmpt470',
            'locale' => 'en',
            'secret' => '8cbb584ab3b563e794dd501b1879c229',
            'database_path' => NULL,
            ...
            'kernel.secret' => '8cbb584ab3b563e794dd501b1879c229',
            ...
            'swiftmailer.transport.smtp.username' => 'group10weweb',
            'swiftmailer.transport.smtp.password' => 'fall2012cmpt470',
            ...
            'swiftmailer.spool.memory.path' => '/var/www/symblog/app/cache/dev/swiftmailer/spool',
            ...
            'jms_aop.cache_dir' => '/var/www/symblog/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/www/symblog/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/symblog/app/cache/dev/jms_diextra/doctrine/EntityManager_50768929a76dd.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50768929a76dd_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/symblog/app/cache/dev/jms_security',
